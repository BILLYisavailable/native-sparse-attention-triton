print("✅ using local Qwen3ForCausalLM!")
...
class Qwen3NSAAttention(nn.Module):
    ...
    def forward(
        ...
        attn_output = attn_output.reshape(attn_output.shape[0], attn_output.shape[1], attn_output.shape[2]*attn_output.shape[3])
...
class Qwen3RotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen3NSAConfig, device=None):
        super().__init__()
